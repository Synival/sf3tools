...
namespace CommonLib.Tests.SGL {
    ...
    public class FractionalTests {
        ...
        public void Constructor_WithRawShortInput_ProducesExpectedResults() {
            var cf1 = new Fractional(0);
            var cf2 = new Fractional(7777);
            var cf3 = new Fractional(32767);
            var cf4 = new Fractional(-32768);
        ...
        public void Constructor_WithFloatInput_ProducesExpectedResults() {
            var cf1 = new Fractional(0.0f, 0);
            var cf2 = new Fractional(0.23733520507f, 0);
            var cf3 = new Fractional(1.00f, 0);
            var cf4 = new Fractional(-1.00f, 0);
        ...
        public void Constructor_WithFIXEDInput_ProducesExpectedResults() {
            var cf1 = new Fractional(new FIXED(0, true));
            var cf2 = new Fractional(new FIXED(15555, true));
            var cf3 = new Fractional(new FIXED(65535, true));
            var cf4 = new Fractional(new FIXED(-65536, true));
