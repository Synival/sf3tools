...
namespace SF3.Models.Tables.MPD {
    public class IndexedTextureTable : TerminatedTable<TextureIDStruct> {
        protected IndexedTextureTable(IByteData data, string name, int address, int terminatorSize, int? maxSize) : base(data, name, address, terminatorSize, maxSize) {
        ...
        public override bool Load() {
            return Load(
                (id, address) => new TextureIDStruct(Data, id, $"IndexedTex_{id:D2}", address),
