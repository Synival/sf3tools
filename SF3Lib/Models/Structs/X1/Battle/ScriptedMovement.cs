...
namespace SF3.Models.Structs.X1.Battle {
    public class ScriptedMovement : Struct {
        ...
        [TableViewModelColumn(displayOrder: 3, displayName: "xPos1")]
        [BulkCopy]
        public int XPos1 {
        ...
        [TableViewModelColumn(displayOrder: 4, displayName: "zPos1")]
        [BulkCopy]
        public int ZPos1 {
        ...
        [TableViewModelColumn(displayOrder: 5, displayName: "xPos2")]
        [BulkCopy]
        public int XPos2 {
        ...
        [TableViewModelColumn(displayOrder: 6, displayName: "zPos2")]
        [BulkCopy]
        public int ZPos2 {
        ...
        [TableViewModelColumn(displayOrder: 7, displayName: "xPos3")]
        [BulkCopy]
        public int XPos3 {
        ...
        [TableViewModelColumn(displayOrder: 8, displayName: "zPos3")]
        [BulkCopy]
        public int ZPos3 {
        ...
        [TableViewModelColumn(displayOrder: 9, displayName: "xPos4")]
        [BulkCopy]
        public int XPos4 {
        ...
        [TableViewModelColumn(displayOrder: 10, displayName: "zPos4")]
        [BulkCopy]
        public int ZPos4 {
