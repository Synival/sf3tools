...
namespace SF3.Models.Structs.MPD {
    public class Boundaries : Struct {
        ...
        : base(data, id, name, address, 0x12) {
            ...
            _cameraX1Addr = address + 0x02; // 2 bytes
            _cameraY1Addr = address + 0x04; // 2 bytes
            _cameraX2Addr = address + 0x06; // 2 bytes
            _cameraY2Addr = address + 0x08; // 2 bytes

            _battleX1Addr = address + 0x0A; // 2 bytes
            _battleY1Addr = address + 0x0C; // 2 bytes
            _battleX2Addr = address + 0x0E; // 2 bytes
            _battleY2Addr = address + 0x10; // 2 bytes
        }
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "CameraX1", displayOrder: 1)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "CameraY1", displayOrder: 2)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "CameraX2", displayOrder: 3)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "CameraY2", displayOrder: 4)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "BattleX1", displayOrder: 5)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "BattleY1", displayOrder: 6)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "BattleX2", displayOrder: 7)]
        ...
        [BulkCopy]
        [TableViewModelColumn(displayName: "BattleY2", displayOrder: 8)]
