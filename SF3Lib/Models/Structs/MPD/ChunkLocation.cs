...
namespace SF3.Models.Structs.MPD {
    public class ChunkLocation : Struct {
        ...
        : base(data, id, name, address, 8) {
            _chunkAddressAddr = Address + 0; // 4 bytes
        ...
        [BulkCopy]
        [TableViewModelColumn(addressField: null, displayName: "Chunk File Address", displayFormat: "X6", displayOrder: 0.5f)]
        ...
        [BulkCopy]
        [TableViewModelColumn(addressField: null, displayName: "Un/decompressed Size", displayFormat: "X4", displayOrder: 4, isReadOnly: true)]
