...
namespace SF3.Models.Structs.MPD.Plane {
    public class PlaneTileTextureRow256 : PlaneTileTextureRow {
        public PlaneTileTextureRow256(IByteData data, int id, string name, int address)
        : base(data, id, name, address, 4) {
        }
