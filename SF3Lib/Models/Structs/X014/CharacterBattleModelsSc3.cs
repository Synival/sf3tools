...
namespace SF3.Models.Structs.X014 {
    public class CharacterBattleModelsSc3 : Struct {
        ...
        public CharacterBattleModelsSc3(IByteData data, int id, string name, int address) : base(data, id, name, address, 0x0C) {
