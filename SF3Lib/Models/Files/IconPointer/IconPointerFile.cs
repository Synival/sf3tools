    ...
    public class IconPointerFile : ScenarioTableFile, IIconPointerFile {
        ...
        public override IEnumerable<ITable> MakeTables() {
            ...
            return new List<ITable>() {
                (SpellIconTable = new SpellIconTable(Data, ResourceFileForScenario(Scenario, "SpellIcons.xml"), spellIconAddress, has16BitIconAddr, spellIconRealOffsetStart)),
                (ItemIconTable  = new ItemIconTable(Data, ResourceFileForScenario(Scenario, "Items.xml"), itemIconAddress, has16BitIconAddr))
            };
        }
