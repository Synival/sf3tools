...
namespace SF3.Models.Files.MPD {
    public class MultiChunkTextureIndexed : CachedTextureData {
        ...
        private MultiChunkTextureIndexed(IPalette palette, bool zeroIsTransparent, ImageDataCanSet canSetImage, MultiChunkTextureDataSource dataSource, IndexedColorUpdateStrategy indexedUpdateStrategy)
