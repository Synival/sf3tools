...
namespace SF3.Models.Files.MPD {
    public class MultiChunkTexture : CachedTextureData {
        public MultiChunkTexture(
        ...
        private MultiChunkTexture(IPalette palette, bool zeroIsTransparent, ImageDataCanSet canSetImage, MultiChunkTextureDataSource dataSource, IndexedColorUpdateStrategy indexedUpdateStrategy)
