namespace SF3.Models.Files.X1 {
    public static class KnownX1Functions {
        public readonly struct FuncInfo {
            public FuncInfo(string typeName, string name, ushort?[] data) {
                TypeName = typeName;
                Name     = name;
                Data     = data;
            }
        ...
        public static FuncInfo[] AllKnownFunctions = new FuncInfo[] {
            ...
            new FuncInfo("Function", "runFunctionWithParam()", new ushort?[] {
            ...
            new FuncInfo("InteractableFunction", "inspectMessageScn1_1()", new ushort?[] {
                0x4F22, 0xD106, 0x410B, 0x0009, 0xD405, 0xD106, 0x410B, 0x0009,
                0xD105, 0x410B, 0x0009, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "inspectMessageScn1_2()", new ushort?[] {
                0x4F22, 0xD106, 0x410B, 0x0009, 0xD505, 0xD106, 0x410B, null,
                0xD105, 0x410B, 0x0009, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardOpenMessageScn1_Tex1()", new ushort?[] {
                0x4F22, 0xD109, 0x410B, 0x0009, 0xE1FF, 0x2F16, 0xD107, null,
                null,   null,   0x410B, null,   0xD105, 0x410B, 0x0009, 0x7F04,
                0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardOpenMessageScn1_Tex2()", new ushort?[] {
                0x4F22, 0xD109, 0x410B, 0x0009, 0x950D, 0xE1FF, 0x2F16, 0xD107,
                null,   null,   0x410B, null,   0xD105, 0x410B, 0x0009, 0x7F04,
                0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardOpenMessageScn1()", new ushort?[] {
                0x4F22, 0xD106, 0x410B, 0x0009, 0xD105, 0xE5FF, 0x410B, null,
                0xD104, 0x410B, 0x0009, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardGetGoldScn1_1()", new ushort?[] {
                0x4F22, 0xD107, 0x410B, 0x0009, 0x9609, 0xD106, null,   0x410B,
                null,   0xD105, 0x410B, 0x0009, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardGetGoldScn1_2()", new ushort?[] {
                0x4F22, 0xD108, 0x410B, 0x0009, 0x9609, 0x9509, 0xD106, 0x410B,
                null,   0xD106, 0x410B, 0x0009, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardGetGoldScn1_Tex1()", new ushort?[] {
                0x4F22, 0xD10A, 0x410B, 0x0009, 0x910F, 0x2F16, null,   0x2F16,
                0xD107, null,   null,   null,   0x410B, null,   0xD105, 0x410B,
                0x0009, 0x7F08, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardGetGoldScn1_Tex2()", new ushort?[] {
                0x4F22, 0xD10B, 0x410B, 0x0009, 0x950F, 0x910F, 0x2F16, null,
                0x2F16, 0xD108, null,   null,   0x410B, null,   0xD106, 0x410B,
                0x0009, 0x7F08, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardShutTightScn2+()", new ushort?[] {
                0x2F86, 0x4F22, 0x9412, 0xD80A, 0x480B, 0x0009, 0x940F, 0x480B,
                0x0009, 0xD108, 0x410B, 0x0009, 0xD407, 0xD108, 0x410B, 0x0009,
                0xD107, 0x410B, 0x0009, 0x4F26, 0x000B, 0x68F6
            }),

            new FuncInfo("InteractableFunction", "cupboardOpenMessageScn2+()", new ushort?[] {
                0x2F86, 0x4F22, 0x9412, 0xD80A, 0x480B, 0x0009, 0x940F, 0x480B,
                0x0009, 0xD108, 0x410B, 0x0009, 0xD107, 0xE5FF, 0x410B, null,
                0xD106, 0x410B, 0x0009, 0x4F26, 0x000B, 0x68F6
            }),

            new FuncInfo("InteractableFunction", "cupboardOpenMessageScn2+_Tex()", new ushort?[] {
                0x4F22, 0x950A, 0xE1FF, 0x2F16, 0xD104, null,   null,   0x410B,
                null,   0x7F04, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "cupboardGetGoldScn2+()", new ushort?[] {
                0x2F86, 0x4F22, 0x9413, 0xD80C, 0x480B, 0x0009, 0x9410, 0x480B,
                0x0009, 0xD10A, 0x410B, 0x0009, 0x960B, 0x950B, 0xD108, 0x410B,
                null,   0xD108, 0x410B, 0x0009, 0x4F26, 0x000B, 0x68F6
            }),

            new FuncInfo("InteractableFunction", "cupboardGetGoldScn2+_Tex()", new ushort?[] {
                0x4F22, 0x950C, 0x910C, 0x2F16, 0x910B, 0x2F16, 0xD105, null,
                null,   0x410B, null,   0x7F08, 0x4F26, 0x000B, 0x0009
            }),

            new FuncInfo("InteractableFunction", "bookshelfReadScn2+(int msgId)", new ushort?[] {
                0x6043, 0x88FF, 0x8F15, 0x4F22, 0xD011, 0x400B, 0x0009, 0xD111,
                0x301D, 0x020A, 0x6103, 0x4100, 0x311A, 0x3218, 0x6123, 0x311C,
                0x312C, 0x3018, 0x6103, 0x4008, 0xD10B, 0x021E, 0xD10B, 0x6023,
                0x301C, 0xD10B, 0x1105, 0x9509, 0xD10A, 0x410B, 0xE4FF, 0x9406,
                0xD109, 0x410B, 0x0009, 0x4F26, 0x000B, 0x0009
            }),
        };
    }
}
