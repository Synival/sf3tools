...
namespace SF3.Models.Files.X1 {
    public static class KnownX1Functions {
        ...
        public static Dictionary<FuncInfo, ushort[]> AllKnownFunctions = new Dictionary<FuncInfo, ushort[]>() {
            ...
            { new FuncInfo("GroundPlaneTickFunc", "updateWaterFunc_ScrollXScrollZAndOscillateAndRippleScn1()"), new ushort[] {
            ...
            { new FuncInfo("GroundPlaneTickFunc", "updateWaterFunc_ScrollWaterZAndRipple()"), new ushort[] {
            ...
            { new FuncInfo("GroundPlaneTickFunc", "updateWaterFunc_ScrollWaterXZAndRipple()"), new ushort[] {
            ...
            { new FuncInfo("GroundPlaneTickFunc", "updateWaterFunc_ScrollWaterXAndRipple_ZScrollRemoved()"), new ushort[] {
            ...
            { new FuncInfo("GroundPlaneTickFunc", "updateWaterFunc_ScrollXScrollZAndOscillateAndRipple()"), new ushort[] {
                0x2F86, 0x2F96, 0x2FA6, 0x4F22, 0xD629, 0x6761, 0xD129, 0x637F,
                0x331D, 0x6233, 0x010A, 0x313C, 0x4121, 0x4121, 0x4121, 0x4121,
                0x4121, 0x4200, 0x322A, 0x3128, 0xE22E, 0x0127, 0xD022, 0x7701,
                0x011A, 0x3318, 0x633F, 0x9138, 0x231F, 0x2671, 0x041A, 0x400B,
