...
namespace SF3.ByteData {
    public class ChunkData : IChunkData {
        ...
        public byte   GetByte(int offset)   => ChildData.GetByte(offset);
        public ushort GetWord(int offset)   => ChildData.GetWord(offset);
        ...
        public void SetWord(int offset, ushort value) => ChildData.SetWord(offset, value);
