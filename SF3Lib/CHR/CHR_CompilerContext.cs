...
namespace SF3.CHR {
    public class CHR_CompilerContext {
        ...
        public Dictionary<string, Bitmap> SpritesheetImageDict = new Dictionary<string, Bitmap>();
        public Dictionary<string, SpritesheetImageRef> ImagesRefsByKey = new Dictionary<string, SpritesheetImageRef>();
        public Dictionary<int, List<(string FrameKey, string AniFrameKey)>> FramesToWriteBySpriteIndex = new Dictionary<int, List<(string FrameKey, string AniFrameKey)>>();
        ...
        public HashSet<string> FinalSpriteFrames = new HashSet<string>();

        // Keep track of frame images already written if we're written frame images sprite-by-sprite.
        public HashSet<string> FrameImagesWritten = new HashSet<string>();
    }
}
