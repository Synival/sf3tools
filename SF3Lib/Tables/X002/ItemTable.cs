...
namespace SF3.Tables.X002 {
    public class ItemTable : Table<Item> {
        ...
        public ItemTable(IX002_FileEditor fileEditor) : base(fileEditor) {
            _fileEditor = fileEditor;
            ResourceFile = ResourceFileForScenario(_fileEditor.Scenario, "Items.xml");
        }
            ...
            try {
                ...
                while (!xml.EOF) {
                    ...
                    if (xml.HasAttributes) {
                        var newRow = new Item(_fileEditor, Convert.ToInt32(xml.GetAttribute(0), 16), xml.GetAttribute(1));
