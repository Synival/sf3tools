    ...
    public class NameGetterContext : INameGetterContext {
        ...
        public NameGetterContext(ScenarioType scenario) {
            ...
            _nameGetters = new Dictionary<NamedValueType, SubMethods>() {
                ...
                { NamedValueType.EffectFileIndex,     new SubMethods((o, p, v, a) => new NameAndInfo(v, ValueNames.EffectFileIndexesInfo.Info[Scenario])) },
                ...
                { NamedValueType.SpecialAnimation,    new SubMethods((o, p, v, a) => new NameAndInfo(v, ValueNames.SpecialAnimationInfo.Info[Scenario])) },
                ...
                { NamedValueType.SpellCategory,       new SubMethods((o, p, v, a) => new NameAndInfo(v, ValueNames.SpellCategoryInfo)) },
                { NamedValueType.SpellEffectType,     new SubMethods((o, p, v, a) => new NameAndInfo(v, ValueNames.SpellEffectTypeInfo)) },
                { NamedValueType.SpellTargetType,     new SubMethods((o, p, v, a) => new NameAndInfo(v, ValueNames.SpellTargetTypeInfo)) },
