    ...
    public static class IMPD_Extensions {
        ...
        public static ushort GetScenario1HeaderFlags(this IMPD mpd) {
            return (ushort) (
              ...
              | F(0x0080, mpd.Flags.Bit_0x0080_HasChunk19ModelWithChunk10Textures)
        ...
        public static ushort GetScenario2HeaderFlags(this IMPD mpd) => GetScenario1HeaderFlags(mpd);

        // TODO: Implement properly!!
        public static ushort GetScenario3HeaderFlags(this IMPD mpd) => GetScenario1HeaderFlags(mpd);

        // TODO: Implement properly!!
        public static ushort GetPremiumDiskHeaderFlags(this IMPD mpd) => GetScenario1HeaderFlags(mpd);
    }
}
