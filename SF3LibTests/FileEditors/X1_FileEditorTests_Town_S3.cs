...
namespace SF3.Tests.FileEditors {
    ...
    public class X1_FileEditorTests_Town_S3 {
        ...
        private static readonly X1_TestCase TestCase = new X1_TestCase(ScenarioType.Scenario3, "X1BEER.BIN", MapLeaderType.Julian);
        ...
        public void EnterTable_HasExpectedData() {
            ...
            Assert.AreEqual(2, table.Rows[2].EnterID);
        ...
        public void TreasureTable_HasExpectedData() {
            ...
            Assert.AreEqual(0x97C, table.Rows[0].TreasureItem);
            ...
            Assert.AreEqual(0xE06C, table.Rows[1].TreasureItem);
