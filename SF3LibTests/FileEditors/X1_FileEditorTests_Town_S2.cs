...
namespace SF3.Tests.FileEditors {
    ...
    public class X1_FileEditorTests_Town_S2 {
        ...
        private static readonly X1_TestCase TestCase = new X1_TestCase(ScenarioType.Scenario2, "X1DUSTY.BIN", MapLeaderType.Medion);
        ...
        public void TreasureTable_HasExpectedData() {
            ...
            Assert.AreEqual(0x909, table.Rows[0].TreasureItem);
            ...
            Assert.AreEqual(0x90A, table.Rows[1].TreasureItem);
