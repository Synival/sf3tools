...
namespace SF3.Tests.FileEditors {
    ...
    public class X1_FileEditorTests_Battle_S2 {
        ...
        private static readonly X1_TestCase TestCase = new X1_TestCase(ScenarioType.Scenario2, "X1BTL204.BIN", MapLeaderType.Medion);
        ...
        public void HeaderTable_HasExpectedData() {
            ...
            Assert.AreEqual(0x04, table.Rows[0].BattlePointersTableOffset);
        ...
        public void TreasureTable_HasExpectedData() {
            ...
            Assert.AreEqual(0x65, table.Rows[0].TreasureItem);
            ...
            Assert.AreEqual(0x55, table.Rows[1].TreasureItem);
            ...
            Assert.AreEqual(0, table.Rows[2].TreasureItem);
