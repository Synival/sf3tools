...
namespace SF3.Tests.Models.Files {
    ...
    public class X033_FileTests {
        private class X033_TestCase : SF3FileTestCase {
        ...
        private static readonly List<X033_TestCase> TestCases = [
            new(ScenarioType.Scenario1,   "X033.BIN", 33, 21),
            new(ScenarioType.Scenario2,   "X033.BIN", 66, 40),
            new(ScenarioType.Scenario3,   "X033.BIN", 143, 59),
            new(ScenarioType.PremiumDisk, "X033.BIN", 144, 60),
        ];
