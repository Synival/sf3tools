...
namespace SF3.Tests.Models.Files {
    ...
    public class X1_FileTests_Battle_S2 {
        ...
        public void AITable_HasExpectedData() {
            ...
            var battle = file.GetBattleMaps()[MapLeaderType.Medion];
            var table = battle.LocationTable;

            Assert.AreEqual(30, table[0].X);
            Assert.AreEqual(24, table[0].Z);

            Assert.AreEqual(21, table[1].X);
            Assert.AreEqual(21, table[1].Z);
        ...
        public void BattlePointersTable_HasExpectedData() {
            var file = TestCase.Create();
            var table = file.BattleHeader.MapPointerTable;
        ...
        public void HeaderTable_HasExpectedData() {
            ...
            Assert.AreEqual(27, header.NumUnits);
        }
