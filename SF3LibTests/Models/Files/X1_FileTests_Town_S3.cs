...
namespace SF3.Tests.Models.Files {
    ...
    public class X1_FileTests_Town_S3 {
        ...
        public void EnterTable_HasExpectedData() {
            ...
            Assert.AreEqual(12, table.Count);
        }
        ...
        public void NpcTable_HasExpectedData() {
            ...
            Assert.AreEqual(240, table[0].ActorX);
            Assert.AreEqual(688, table[0].ActorZ);

            Assert.AreEqual(0x217, table[1].SpriteID);
            Assert.AreEqual(368, table[1].ActorX);
            Assert.AreEqual(880, table[1].ActorZ);
        ...
        public void TreasureTable_HasExpectedData() {
            ...
            Assert.AreEqual(27, table.Count);
        }
        ...
        public void WarpTable_HasExpectedData() {
            ...
            Assert.AreEqual(2, table[1].SubLoadID);
