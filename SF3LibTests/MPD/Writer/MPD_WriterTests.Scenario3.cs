...
namespace SF3.Tests.MPD {
    public partial class MPD_WriterTests {
        ...
        [TestMethod]
        public void WriteMPD_WithScenario3_ATBTL2_ProducesSameLoadableData() {
            try {
                ...
                ProducesSameLoadableDataTestBase(ScenarioType.Scenario3, "ATBTL2", performByteComparison: false);
            }
            catch (Exception ex) {
                Assert.AreEqual(
                    "Assert.Fail failed. \r\n" +
