    ...
    public partial class SF3EditorForm {
        private void InitSettingsMenu() {
            ...
            _appState.HighlightEndCodesInTextureViewChanged += (s, e)
                => tsmiSettings_HighlightEndCodes.Checked = _appState.HighlightEndCodesInTextureView; _appState.Serialize();
        ...
        private void tsmiSettings_HighlightEndCodes_Click(object sender, EventArgs e)
