...
namespace SF3.Editor.Forms {
    public partial class SF3EditorForm {
        private void InitViewMenu() {
            ...
            _appState.ViewerDrawSurfaceModelChanged += (s, e)
            ...
            _appState.ViewerDrawBoundariesChanged += (s, e)
                => { tsmiView_MPD_DrawBoundaries.Checked = _appState.ViewerDrawBoundaries; _appState.Serialize(); };
            _appState.ViewerDrawTerrainTypesChanged   += (s, e)
                => { tsmiView_MPD_DrawTerrainTypes.Checked = _appState.ViewerDrawTerrainTypes; _appState.Serialize(); };
            _appState.ViewerDrawEventIDsChanged += (s, e)
                => { tsmiView_MPD_DrawEventIDs.Checked = _appState.ViewerDrawEventIDs; _appState.Serialize(); };
            _appState.ViewerDrawCollisionLinesChanged += (s, e)
