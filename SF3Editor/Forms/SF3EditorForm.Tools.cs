    ...
    public partial class SF3EditorForm {
        ...
        public void CopyTablesTo(LoadedFile file) {
            ...
            try {
                ...
                if (!copyModelLoader.LoadFile(copyToFilename, null, loader => CreateFile(loader.ByteData, fileType, c_nameGetterContexts, scenario, Path.GetFileName(loader.Filename)))) {
        ...
        public void CopyTablesFrom(LoadedFile file) {
            ...
            try {
                var copyModelLoader = new ModelFileLoader();
                if (!copyModelLoader.LoadFile(copyFromFilename, null, loader => CreateFile(loader.ByteData, fileType, c_nameGetterContexts, scenario, Path.GetFileName(loader.Filename)))) {
                    ErrorMessage("Error trying to load file. It is probably in use by another process.");
                    return;
                }
