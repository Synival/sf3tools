...
namespace CommonLib.Imaging {
    public class MockAnimatedTextureFrame : IAnimatedTextureFrame, IDisposable {
        public MockAnimatedTextureFrame(ITexture texture) {
            _texture = texture;
        ...
        protected readonly ITexture _texture;
