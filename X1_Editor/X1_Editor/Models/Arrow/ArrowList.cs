...
namespace STHAEditor.Models.Arrows
{
    public static class ArrowList
    {
        private static Arrow[] itemssorted;
        private static Arrow[] items;
        ...
        public static bool loadArrowList()
        {
        ...
        public static Arrow[] getArrowList()
        {
            return itemssorted;
        }
        public static Arrow getArrowss(int id)
        {
            return items[id];
        }
    }
