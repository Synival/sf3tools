...
using SF3.Win.Views.X007;
using SF3.Win.Views.X011;
using SF3.Win.Views.X012;
using SF3.Win.Views.X013;
using SF3.Win.Views.X014;
using SF3.Win.Views.X016;
using SF3.Win.Views.X017;
using SF3.Win.Views.X018;
    ...
    public class FileView : IView, IDisposable {
        ...
        private IView CreateActualView() {
            switch (File) {
                ...
                case IX007_File file: return new X007_View("X007_File", file);
                ...
                case IX016_File file: return new X016_View("X016_File", file);
                case IX017_File file: return new X017_View("X017_File", file);
                case IX018_File file: return new X018_View("X018_File", file);
                ...
                case IX032_File file: return new X032_View("X032_File", file);
                case IX033_File file: return new X033_View("X033_File", file);
                case IX035_File file: return new X035_View("X035_File", file);
                case IX044_File file: return new X044_View("X044_File", file);
                case IMPD       file: return new MPD_View ("MPD_File",  file);
