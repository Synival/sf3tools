                        ...
                        for (int ty = -1; ty <= 1; ty++) {
                            for (int tx = -1; tx <= 1; tx++) {
                                ...
                                if (tileX > 0 && tileX < 64 && tileY > 0 && tileY < 64) {
                                    ...
                                    var heights1 = tile.GetSurfaceVertexHeight(CornerType.BottomLeft) * xInTile + tile.GetSurfaceVertexHeight(CornerType.BottomRight) * (1.0f - xInTile);
                                    var heights2 = tile.GetSurfaceVertexHeight(CornerType.TopLeft)    * xInTile + tile.GetSurfaceVertexHeight(CornerType.TopRight)    * (1.0f - xInTile);
